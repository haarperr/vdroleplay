var items = [
    {itemName: "COMBAT PISTOL", itemWeight: 1.0, usable: true, consumable: false, icon: '../items/combat-pistol.png', stackable: false, description: "Mooi wapentje hoor", callback: "useWeapon"},
    {itemName: "CARBINE RIFLE", itemWeight: 1.0, usable: true, consumable: false, icon: '../items/carbine-rifle.png', stackable: false, description: "Mooi wapentje hoor", callback: "useWeapon"},
    {itemName: "STUN GUN", itemWeight: 1.0, usable: true, consumable: false, icon: '../items/carbine-rifle.png', stackable: false, description: "Mooi wapentje hoor", callback: "useWeapon"},
